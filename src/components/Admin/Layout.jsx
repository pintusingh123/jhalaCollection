...
const Layout = ({ children }) => {
  ...
  const menu = [
    ...
    },
    {
      to: "/admin/customer",
      label: "Customer",
      icon: <i class="ri-customer-service-2-fill"></i>,
    },
    {
      to: "/admin/product",
      label: "Product",
    ...
    <div className="min-h-screen bg-slate-100 flex overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col py-4">
          ...
          <button className="flex items-center gap-3 px-5 py-3 hover:bg-sky-800 transition">
      ...
      >
        ...
        {/* Page Content */}
        <main
          className=" p-3 sm:p-4 md:p-5 lg:p-6 w-full min-w-0 overflow-x-auto">
          {children}
        </main>
      </div>
    </div>
