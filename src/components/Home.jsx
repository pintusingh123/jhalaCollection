        ...
        <div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto text-sm sm:text-base">
              Explore our latest collection of premium gadgets and tech gear tailored to enhance your daily lifestyle.
            </p>
          </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2.5 mt-5">
                        <button className="flex-1 bg-black text-white py-2.5 rounded-xl font-bold hover:bg-yellow-500 hover:text-black transition-all duration-300 flex items-center justify-center gap-1.5 text-xs sm:text-sm shadow-md hover:shadow-yellow-500/10 cursor-pointer">
                          Add To Cart
                        </button>

                        <button className="px-4 py-2.5 border border-gray-200 rounded-xl text-xs sm:text-sm font-bold hover:bg-gray-50 hover:border-black transition duration-300 flex items-center justify-center cursor-pointer">
                          Buy
                        </button>
                      </div>
                    </div>
